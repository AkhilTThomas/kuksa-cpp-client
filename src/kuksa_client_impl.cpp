...
static const std::string loggerName = "kuksaClient";

KuksaClient::KuksaClientImpl::KuksaClientImpl() {
...
bool KuksaClient::KuksaClientImpl::connect_v1(const std::string &server) {
...
bool KuksaClient::KuksaClientImpl::get(const std::string &datapoint,
...
bool KuksaClient::KuksaClientImpl::set(const std::string &datapoint,
...
void KuksaClient::KuksaClientImpl::subscribe(
    const std::vector<std::string> &datapoints, kuksaCallbackV1 callback) {
...
bool KuksaClient::KuksaClientImpl::connect_v2(const std::string &server) {
...
bool KuksaClient::KuksaClientImpl::getValue(const std::string &datapoint,
...
void KuksaClient::KuksaClientImpl::subscribe(
    const std::vector<std::string> &datapoints, kuksaCallbackV2 callback) {
...
bool KuksaClient::KuksaClientImpl::actuate(const std::string &datapoint,
...
bool KuksaClient::KuksaClientImpl::publishValue(
    const std::string &datapoint, const kuksa::val::v2::Value &value) {
...
bool KuksaClient::KuksaClientImpl::getServerInfo(
...
std::vector<kuksa::val::v2::Datapoint> KuksaClient::KuksaClientImpl::getValues(
  ...
  const grpc::Status status = mStubV2->GetValues(&context, request, &response);
  if (status.ok()) {
